...
return $this->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\ServiceLocator(array('hinclude' => function () {
    return ($this->privates['fragment.renderer.hinclude'] ?? $this->load('getFragment_Renderer_HincludeService.php'));
}, 'inline' => function () {
