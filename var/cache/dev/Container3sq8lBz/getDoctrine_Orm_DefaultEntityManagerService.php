...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\InfosRepository' => function () {
...
}, 'App\\Repository\\ProductTrackingRepository' => function () {
    return ($this->privates['App\Repository\ProductTrackingRepository'] ?? $this->load('getProductTrackingRepositoryService.php'));
}, 'App\\Repository\\PurchaseHistoryRepository' => function () {
    return ($this->privates['App\Repository\PurchaseHistoryRepository'] ?? $this->load('getPurchaseHistoryRepositoryService.php'));
