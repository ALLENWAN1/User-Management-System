...
// Returns the private 'App\Repository\PurchaseHistoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PurchaseHistoryRepository.php';

return $this->privates['App\Repository\PurchaseHistoryRepository'] = new \App\Repository\PurchaseHistoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
