...
// Returns the private 'App\Repository\ProductTrackingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProductTrackingRepository.php';

return $this->privates['App\Repository\ProductTrackingRepository'] = new \App\Repository\ProductTrackingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
