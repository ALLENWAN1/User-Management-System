...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ProductTrackingType' => function () {
    return ($this->privates['App\Form\ProductTrackingType'] ?? $this->privates['App\Form\ProductTrackingType'] = new \App\Form\ProductTrackingType());
    ...
    return ($this->privates['app.form.profile'] ?? $this->privates['app.form.profile'] = new \App\Form\ProfileType());
}, 'App\\Form\\PurchaseType' => function () {
    return ($this->privates['app.form.pruchasehistroy'] ?? $this->privates['app.form.pruchasehistroy'] = new \App\Form\PurchaseType());
}, 'App\\Form\\RegistrationType' => function () {
    return ($this->privates['app.form.registration'] ?? $this->privates['app.form.registration'] = new \App\Form\RegistrationType());
}, 'App\\Form\\UserListAddType' => function () {
    return ($this->privates['app.form.userListAdd'] ?? $this->privates['app.form.userListAdd'] = new \App\Form\UserListAddType());
}, 'App\\Form\\UserListEditType' => function () {
    return ($this->privates['app.form.userListEdit'] ?? $this->privates['app.form.userListEdit'] = new \App\Form\UserListEditType());
